...
if (isset($_POST["mtfa"])){
    ...
    $conferir14="SELECT * FROM t_abril WHERE Day = $dia";
    //$conferir3="SELECT * FROM t_abril WHERE  Day=$dia and Tarefa3 = NULL";
    $conferir1="SELECT * FROM t_abril WHERE Day = $dia ";
   ...
   // $resp23=mysqli_query($con,$conferir23);
    ...
    $lin14=mysqli_num_rows($resp14);
        ...
        if ($lin14 == '0') { #Se não tiver nenhuma coluna, ou seja, o número for igual a 0, ela cria uma coluna nova.
            $sql="INSERT INTO t_abril (Day, Tarefa) VALUES ($dia,'$maccabeus')";  #aqui ele seta para criar uma nova coluna, com o dia e a tarefa apresentada
            $res=mysqli_query($con,$sql);  #aqui ele cria definitivamente
        }
        if ($lin14 == '1' ) {
            $up2="UPDATE t_abril SET Tarefa2='$maccabeus' WHERE Day=$dia";
...
if(isset($_POST["apg"])){
    $apaga=$_POST['apg'];
    $conferir2="SELECT * FROM t_abril WHERE Day = $apaga";
    $resp2=mysqli_query($con,$conferir2);
    $lin2=mysqli_num_rows($resp2);
    echo $apaga;
        if ($lin2 > 0){
            $handel="DELETE FROM t_abril WHERE Day = $apaga";
    ...
    //$consultat="SELECT * FROM t_abril WHERE Day ='1'";
    //$cvc=$mysqli->query($consultat) or die($mysqli->error);
}
function listar_mensagem($lday){
    $con=mysqli_connect("localhost","root","vertrigo");
    mysqli_select_db($con,"calendario"); 
    $sql72 = "SELECT Tarefa, Tarefa2 FROM t_abril WHERE Day = $lday";
...
<h1 id="titulomes">Abril</h1>
<p>oba</p><br>
<p>oba</p><br>
<p>oba</p><br>
<?php
    $dia1 = listar_mensagem("1");$byr1d=isset($dia1)?$dia1:1;
    $dia2 = listar_mensagem("2");$byr2d=isset($dia2)?$dia2:2;
    $dia3 = listar_mensagem("3");$byr3d=isset($dia3)?$dia3:3;
    $dia4 = listar_mensagem("4");$byr4d=isset($dia4)?$dia4:4;
    $dia5 = listar_mensagem("5");$byr5d=isset($dia5)?$dia5:"5-Sem aula";//
    $dia6 = listar_mensagem("6");$byr6d=isset($dia6)?$dia6:6;
    $dia7 = listar_mensagem("7");$byr7d=isset($dia7)?$dia7:7;
    $dia8 = listar_mensagem("8");$byr8d=isset($dia8)?$dia8:8;
    $dia9 = listar_mensagem("9");$byr9d=isset($dia9)?$dia9:9;
    $dia10 = listar_mensagem("10");$byr10d=isset($dia10)?$dia10:10;
    $dia11 = listar_mensagem("11");$byr11d=isset($dia11)?$dia11:11;
    $dia12 = listar_mensagem("12");$byr12d=isset($dia12)?$dia12:"12-Sem aula";//
    $dia13 = listar_mensagem("13");$byr13d=isset($dia13)?$dia13:13;
    $dia14 = listar_mensagem("14");$byr14d=isset($dia14)?$dia14:14;
    $dia15 = listar_mensagem("15");$byr15d=isset($dia15)?$dia15:15;
    $dia16 = listar_mensagem("16");$byr16d=isset($dia16)?$dia16:16;
    $dia17 = listar_mensagem("17");$byr17d=isset($dia17)?$dia17:17;
    $dia18 = listar_mensagem("18");$byr18d=isset($dia18)?$dia18:18;
    $dia19 = listar_mensagem("19");$byr19d=isset($dia19)?$dia19:"19-Sem aula";//
    $dia20 = listar_mensagem("20");$byr20d=isset($dia20)?$dia20:20;
    $dia21 = listar_mensagem("21");$byr21d=isset($dia21)?$dia21:21;
    $dia22 = listar_mensagem("22");$byr22d=isset($dia22)?$dia22:22;
    $dia23 = listar_mensagem("23");$byr23d=isset($dia23)?$dia23:23;
    $dia24 = listar_mensagem("24");$byr24d=isset($dia24)?$dia24:24;
    $dia25 = listar_mensagem("25");$byr25d=isset($dia25)?$dia25:25;
    $dia26 = listar_mensagem("26");$byr26d=isset($dia26)?$dia26:"26-Sem aula";//
    $dia27 = listar_mensagem("27");$byr27d=isset($dia27)?$dia27:27;
    $dia28 = listar_mensagem("28");$byr28d=isset($dia28)?$dia28:28;
    $dia29 = listar_mensagem("29");$byr29d=isset($dia29)?$dia29:29;
    $dia30 = listar_mensagem("30");$byr30d=isset($dia30)?$dia30:30;
    $dia31 = listar_mensagem("31");$byr31d=isset($dia31)?$dia31:31;
?>
<p>oba</p><br>
<div id="corpo">
<p id="titulomes">Abril</p>
...
<table id="tabela">
    ...
    <tr><td id="33d" class="si"><?php echo"";?></td><td id="32d" class="se"><?php echo"";?></td><td id="33d" class="se"><?php echo"";?></td><td id="1d" class="se"><?php echo"$byr1d";?></td><td id="2d" class="se"><?php echo"$byr2d ";?></td><td id="3d" class="se"><?php echo"$byr3d";?></td><td id="4d" class="so"><?php echo"$byr4d";?></td></tr>
    <tr><td id="5d" class="si"><?php echo"$byr5d";?></td><td id="6d" class="se"><?php echo"$byr6d ";?></td><td id="7d" class="se"><?php echo"$byr7d";?></td><td id="8d" class="se"><?php echo"$byr8d ";?></td><td id="9d" class="se"><?php echo"$byr9d ";?></td><td id="10d" class="se"><?php echo"$byr10d";?></td><td id="11d" class="so"><?php echo"$byr11d ";?></td></tr>
    <tr><td id="12d" class="si"><?php echo"$byr12d ";?></td><td id="13d" class="se"><?php echo"$byr13d ";?></td><td id="14d" class="se"><?php echo"$byr14d";?></td><td id="15d" class="se"><?php echo"$byr15d ";?></td><td id="16d" class="se"><?php echo"$byr16d";?></td><td id="17d" class="se"><?php echo"$byr17d ";?></td><td id="18d" class="so"><?php echo"$byr18d ";?></td></tr>
    <tr><td id="19d" class="si"><?php echo"$byr19d ";?></td><td id="20d" class="se"><?php echo"$byr20d ";?></td><td id="21d" class="se"><?php echo"$byr21d ";?></td><td id="22d" class="se"><?php echo"$byr22d ";?></td><td id="23d" class="se"><?php echo"$byr23d ";?></td><td id="24d" class="se"><?php echo"$byr24d";?></td><td id="25d" class="so"><?php echo"$byr25d ";?></td></tr>
    <tr><td id="26d" class="si"><?php echo"$byr26d ";?></td><td id="27d" class="se"><?php echo"$byr27d ";?></td><td id="28d" class="se"><?php echo"$byr28d ";?></td><td id="29d" class="se"><?php echo"$byr29d ";?></td><td id="30d" class="se"><?php echo"$byr30d";?></td></tr>
</table>
</div>
<br>
<br>
