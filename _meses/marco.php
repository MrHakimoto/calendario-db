...
if (isset($_POST["mtfa"])){
    ...
    $conferir14="SELECT * FROM t_marco WHERE Day = $dia";
    //$conferir3="SELECT * FROM t_marco WHERE  Day=$dia and Tarefa3 = NULL";
    $conferir1="SELECT * FROM t_marco WHERE Day = $dia ";
   ...
   // $resp23=mysqli_query($con,$conferir23);
    ...
    $lin14=mysqli_num_rows($resp14);
        ...
        if ($lin14 == '0') { #Se não tiver nenhuma coluna, ou seja, o número for igual a 0, ela cria uma coluna nova.
            $sql="INSERT INTO t_marco (Day, Tarefa) VALUES ($dia,'$maccabeus')";  #aqui ele seta para criar uma nova coluna, com o dia e a tarefa apresentada
            $res=mysqli_query($con,$sql);  #aqui ele cria definitivamente
        }
        if ($lin14 == '1' ) {
            $up2="UPDATE t_marco SET Tarefa2='$maccabeus' WHERE Day=$dia";
...
if(isset($_POST["apg"])){
    $apaga=$_POST['apg'];
    $conferir2="SELECT * FROM t_marco WHERE Day = $apaga";
    $resp2=mysqli_query($con,$conferir2);
    $lin2=mysqli_num_rows($resp2);
    echo $apaga;
        if ($lin2 > 0){
            $handel="DELETE FROM t_marco WHERE Day = $apaga";
    ...
    //$consultat="SELECT * FROM t_marco WHERE Day ='1'";
    //$cvc=$mysqli->query($consultat) or die($mysqli->error);
}
function listar_mensagem($lday){
    $con=mysqli_connect("localhost","root","vertrigo");
    mysqli_select_db($con,"calendario"); 
    $sql72 = "SELECT Tarefa, Tarefa2 FROM t_marco WHERE Day = $lday";
...
<p id="workk">Tarefa</p>
<?php
    $dia1 = listar_mensagem("1");$ni1d=isset($dia1)?$dia1:"1-Sem aula";;
    $dia2 = listar_mensagem("2");$ni2d=isset($dia2)?$dia2:2;
    $dia3 = listar_mensagem("3");$ni3d=isset($dia3)?$dia3:3;
    $dia4 = listar_mensagem("4");$ni4d=isset($dia4)?$dia4:4;
    $dia5 = listar_mensagem("5");$ni5d=isset($dia5)?$dia5:5;
    $dia6 = listar_mensagem("6");$ni6d=isset($dia6)?$dia6:6;
    $dia7 = listar_mensagem("7");$ni7d=isset($dia7)?$dia7:7;
    $dia8 = listar_mensagem("8");$ni8d=isset($dia8)?$dia8:"8-Sem aula";
    $dia9 = listar_mensagem("9");$ni9d=isset($dia9)?$dia9:9;
    $dia10 = listar_mensagem("10");$ni10d=isset($dia10)?$dia10:10;
    $dia11 = listar_mensagem("11");$ni11d=isset($dia11)?$dia11:11;
    $dia12 = listar_mensagem("12");$ni12d=isset($dia12)?$dia12:12;
    $dia13 = listar_mensagem("13");$ni13d=isset($dia13)?$dia13:13;
    $dia14 = listar_mensagem("14");$ni14d=isset($dia14)?$dia14:14;
    $dia15 = listar_mensagem("15");$ni15d=isset($dia15)?$dia15:"15-Sem aula";
    $dia16 = listar_mensagem("16");$ni16d=isset($dia16)?$dia16:16;
    $dia17 = listar_mensagem("17");$ni17d=isset($dia17)?$dia17:17;
    $dia18 = listar_mensagem("18");$ni18d=isset($dia18)?$dia18:18;
    $dia19 = listar_mensagem("19");$ni19d=isset($dia19)?$dia19:19;
    $dia20 = listar_mensagem("20");$ni20d=isset($dia20)?$dia20:20;
    $dia21 = listar_mensagem("21");$ni21d=isset($dia21)?$dia21:21;
    $dia22 = listar_mensagem("22");$ni22d=isset($dia22)?$dia22:"22-Sem aula";
    $dia23 = listar_mensagem("23");$ni23d=isset($dia23)?$dia23:23;
    $dia24 = listar_mensagem("24");$ni24d=isset($dia24)?$dia24:24;
    $dia25 = listar_mensagem("25");$ni25d=isset($dia25)?$dia25:25;
    $dia26 = listar_mensagem("26");$ni26d=isset($dia26)?$dia26:26;
    $dia27 = listar_mensagem("27");$ni27d=isset($dia27)?$dia27:27;
    $dia28 = listar_mensagem("28");$ni28d=isset($dia28)?$dia28:28;
    $dia29 = listar_mensagem("29");$ni29d=isset($dia29)?$dia29:"29-Sem aula";
    $dia30 = listar_mensagem("30");$ni30d=isset($dia30)?$dia30:30;
    $dia31 = listar_mensagem("31");$ni31d=isset($dia31)?$dia31:31;
?>
<div id="aobis">
<table id="tabela">
    ...
    <tr><td id="1d" class="si"><?php echo"$ni1d";?></td><td id="2d" class="se"><?php echo"$ni2d";?></td><td id="3d" class="se"><?php echo"$ni3d";?></td><td id="4d" class="se"><?php echo"$ni4d";?></td><td id="5d" class="se"><?php echo"$ni5d";?></td><td id="6d" class="se"><?php echo"$ni6d";?></td><td id="7d" class="so"><?php echo"$ni7d";?></td></tr>
    <tr><td id="8d" class="si"><?php echo"$ni8d";?></td><td id="9d" class="se"><?php echo"$ni9d";?></td><td id="10d" class="se"><?php echo"$ni10d";?></td><td id="11d" class="se"><?php echo"$ni11d";?></td><td id="12d" class="se"><?php echo"$ni12d";?></td><td id="13d" class="se"><?php echo"$ni13d";?></td><td id="14d" class="so"><?php echo"$ni14d ";?></td></tr>
    <tr><td id="15d" class="si"><?php echo"$ni15d";?></td><td id="16d" class="se"><?php echo"$ni16d";?></td><td id="17d" class="se"><?php echo"$ni17d";?></td><td id="18d" class="se"><?php echo"$ni18d";?></td><td id="19d" class="se"><?php echo"$ni19d ";?></td><td id="20d" class="se"><?php echo"$ni20d";?></td><td id="21d" class="so"><?php echo"$ni21d";?></td></tr>
    <tr><td id="22d" class="si"><?php echo"$ni22d";?></td><td id="23d" class="se"><?php echo"$ni23d ";?></td><td id="24d" class="se"><?php echo"$ni24d ";?></td><td id="25d" class="se"><?php echo"$ni25d";?></td><td id="26d" class="se"><?php echo"$ni26d ";?></td><td id="27d" class="se"><?php echo"$ni27d";?></td><td id="28d" class="so"><?php echo"$ni28d";?></td></tr>
    <tr><td id="29d" class="si"><?php echo"$ni29d";?></td><td id="30d" class="se"><?php echo"$ni30d";?></td><td id="31d" class="se"><?php echo"$ni31d ";?></td></tr>
</table>
</div>
<br>
<br>
...
<form id="fform" name="fcad" method="POST" action="marco.php">
 <fieldset id="mat">
    ...
    <form method="POST" action="marco.php">
     <fieldset id="mat">
