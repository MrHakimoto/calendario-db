...
if (isset($_POST["mtfa"])){
    ...
    $conferir14="SELECT * FROM t_outubro WHERE Day = $dia";
    //$conferir3="SELECT * FROM t_outubro WHERE  Day=$dia and Tarefa3 = NULL";
    $conferir1="SELECT * FROM t_outubro WHERE Day = $dia ";
   ...
   // $resp23=mysqli_query($con,$conferir23);
    ...
    $lin14=mysqli_num_rows($resp14);
        ...
        if ($lin14 == '0') { #Se não tiver nenhuma coluna, ou seja, o número for igual a 0, ela cria uma coluna nova.
            $sql="INSERT INTO t_outubro (Day, Tarefa) VALUES ($dia,'$maccabeus')";  #aqui ele seta para criar uma nova coluna, com o dia e a tarefa apresentada
            $res=mysqli_query($con,$sql);  #aqui ele cria definitivamente
        }
        if ($lin14 == '1' ) {
            $up2="UPDATE t_outubro SET Tarefa2='$maccabeus' WHERE Day=$dia";
...
if(isset($_POST["apg"])){
    $apaga=$_POST['apg'];
    $conferir2="SELECT * FROM t_outubro WHERE Day = $apaga";
    $resp2=mysqli_query($con,$conferir2);
    $lin2=mysqli_num_rows($resp2);
    echo $apaga;
        if ($lin2 > 0){
            $handel="DELETE FROM t_outubro WHERE Day = $apaga";
    ...
    //$consultat="SELECT * FROM t_outubro WHERE Day ='1'";
    //$cvc=$mysqli->query($consultat) or die($mysqli->error);
}
function listar_mensagem($lday){
    $con=mysqli_connect("localhost","root","vertrigo");
    mysqli_select_db($con,"calendario"); 
    $sql72 = "SELECT Tarefa, Tarefa2 FROM t_outubro WHERE Day = $lday";
...
<br><br>
<?php
    $dia1 = listar_mensagem("1");$ll1d=isset($dia1)?$dia1:1;
    $dia2 = listar_mensagem("2");$ll2d=isset($dia2)?$dia2:2;
    $dia3 = listar_mensagem("3");$ll3d=isset($dia3)?$dia3:3;
    $dia4 = listar_mensagem("4");$ll4d=isset($dia4)?$dia4:"4-Sem aula";
    $dia5 = listar_mensagem("5");$ll5d=isset($dia5)?$dia5:5;
    $dia6 = listar_mensagem("6");$ll6d=isset($dia6)?$dia6:6;
    $dia7 = listar_mensagem("7");$ll7d=isset($dia7)?$dia7:7;
    $dia8 = listar_mensagem("8");$ll8d=isset($dia8)?$dia8:8;
    $dia9 = listar_mensagem("9");$ll9d=isset($dia9)?$dia9:9;
    $dia10 = listar_mensagem("10");$ll10d=isset($dia10)?$dia10:10;
    $dia11 = listar_mensagem("11");$ll11d=isset($dia11)?$dia11:"11-Sem aula";
    $dia12 = listar_mensagem("12");$ll12d=isset($dia12)?$dia12:12;
    $dia13 = listar_mensagem("13");$ll13d=isset($dia13)?$dia13:13;
    $dia14 = listar_mensagem("14");$ll14d=isset($dia14)?$dia14:14;
    $dia15 = listar_mensagem("15");$ll15d=isset($dia15)?$dia15:15;
    $dia16 = listar_mensagem("16");$ll16d=isset($dia16)?$dia16:16;
    $dia17 = listar_mensagem("17");$ll17d=isset($dia17)?$dia17:17;
    $dia18 = listar_mensagem("18");$ll18d=isset($dia18)?$dia18:"18-Sem aula";
    $dia19 = listar_mensagem("19");$ll19d=isset($dia19)?$dia19:19;
    $dia20 = listar_mensagem("20");$ll20d=isset($dia20)?$dia20:20;
    $dia21 = listar_mensagem("21");$ll21d=isset($dia21)?$dia21:21;
    $dia22 = listar_mensagem("22");$ll22d=isset($dia22)?$dia22:22;
    $dia23 = listar_mensagem("23");$ll23d=isset($dia23)?$dia23:23;
    $dia24 = listar_mensagem("24");$ll24d=isset($dia24)?$dia24:24;
    $dia25 = listar_mensagem("25");$ll25d=isset($dia25)?$dia25:"25-Sem aula";
    $dia26 = listar_mensagem("26");$ll26d=isset($dia26)?$dia26:26;
    $dia27 = listar_mensagem("27");$ll27d=isset($dia27)?$dia27:27;
    $dia28 = listar_mensagem("28");$ll28d=isset($dia28)?$dia28:28;
    $dia29 = listar_mensagem("29");$ll29d=isset($dia29)?$dia29:29;
    $dia30 = listar_mensagem("30");$ll30d=isset($dia30)?$dia30:30;
    $dia31 = listar_mensagem("31");$ll31d=isset($dia31)?$dia31:31;
?>
<p id="workk">Tarefa</p>
<div id="aobis">
<table id="tabela">
    ...
    <tr><td class="si"><?php echo"";?></td><td class="se"><?php echo"";?></td><td class="se"><?php echo"";?></td><td class="se"><?php echo"";?></td><td id="1d" class="se"><?php echo"$ll1d ";?></td><td id="2d" class="se"><?php echo"$ll2d ";?></td><td id="3d" class="so"><?php echo"$ll3d ";?></td></tr>
    <tr><td id="4d" class="si"><?php echo"$ll4d ";?></td><td id="5d" class="se"><?php echo"$ll5d ";?></td><td id="6d" class="se"><?php echo"$ll6d ";?></td><td id="7d" class="se"><?php echo"$ll7d ";?></td><td id="8d" class="se"><?php echo"$ll8d ";?></td><td id="9d" class="se"><?php echo"$ll9d ";?></td><td id="10d" class="so"><?php echo"$ll10d ";?></td></tr>
    <tr><td id="11d" class="si"><?php echo"$ll11d ";?></td><td id="12d" class="se"><?php echo"$ll12d ";?></td><td id="13d" class="se"><?php echo"$ll13d ";?></td><td id="14d" class="se"><?php echo"$ll14d ";?></td><td id="15d" class="se"><?php echo"$ll15d ";?></td><td id="16d" class="se"><?php echo"$ll16d ";?></td><td id="17d" class="so"><?php echo"$ll17d ";?></td></tr>
    <tr><td id="18d" class="si"><?php echo"$ll18d ";?></td><td id="19d" class="se"><?php echo"$ll19d ";?></td><td id="20d" class="se"><?php echo"$ll20d ";?></td><td id="21d" class="se"><?php echo"$ll21d ";?></td><td id="22d" class="se"><?php echo"$ll22d ";?></td><td id="23d" class="se"><?php echo"$ll23d ";?></td><td id="24d" class="so"><?php echo"$ll24d ";?></td></tr>
    <tr><td id="25d" class="si"><?php echo"$ll25d ";?></td><td id="26d" class="se"><?php echo"$ll26d ";?></td><td id="27d" class="se"><?php echo"$ll27d ";?></td><td id="28d" class="se"><?php echo"$ll28d ";?></td><td id="29d" class="se"><?php echo"$ll29d ";?></td><td id="30d" class="se"><?php echo"$ll30d ";?></td><td id="31d" class="so"><?php echo"$ll31d ";?></td></tr>
</table>
</div>
<br>
<br>
