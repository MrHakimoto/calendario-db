...
if (isset($_POST["mtfa"])){
    ...
    $conferir14="SELECT * FROM t_maio WHERE Day = $dia";
    //$conferir3="SELECT * FROM t_maio WHERE  Day=$dia and Tarefa3 = NULL";
    $conferir1="SELECT * FROM t_maio WHERE Day = $dia ";
   ...
   // $resp23=mysqli_query($con,$conferir23);
    ...
    $lin14=mysqli_num_rows($resp14);
        ...
        if ($lin14 == '0') { #Se não tiver nenhuma coluna, ou seja, o número for igual a 0, ela cria uma coluna nova.
            $sql="INSERT INTO t_maio (Day, Tarefa) VALUES ($dia,'$maccabeus')";  #aqui ele seta para criar uma nova coluna, com o dia e a tarefa apresentada
            $res=mysqli_query($con,$sql);  #aqui ele cria definitivamente
        }
        if ($lin14 == '1' ) {
            $up2="UPDATE t_maio SET Tarefa2='$maccabeus' WHERE Day=$dia";
...
if(isset($_POST["apg"])){
    $apaga=$_POST['apg'];
    $conferir2="SELECT * FROM t_maio WHERE Day = $apaga";
    $resp2=mysqli_query($con,$conferir2);
    $lin2=mysqli_num_rows($resp2);
    echo $apaga;
        if ($lin2 > 0){
            $handel="DELETE FROM t_maio WHERE Day = $apaga";
    ...
    //$consultat="SELECT * FROM t_maio WHERE Day ='1'";
    //$cvc=$mysqli->query($consultat) or die($mysqli->error);
}
function listar_mensagem($lday){
    $con=mysqli_connect("localhost","root","vertrigo");
    mysqli_select_db($con,"calendario"); 
    $sql72 = "SELECT Tarefa, Tarefa2 FROM t_maio WHERE Day = $lday";
...
<br><br>
<?php
    $dia1 = listar_mensagem("1");$m1d=isset($dia1)?$dia1:1;
    $dia2 = listar_mensagem("2");$m2d=isset($dia2)?$dia2:2;
    $dia3 = listar_mensagem("3");$m3d=isset($dia3)?$dia3:"3-Sem aula";
    $dia4 = listar_mensagem("4");$m4d=isset($dia4)?$dia4:4;
    $dia5 = listar_mensagem("5");$m5d=isset($dia5)?$dia5:5;
    $dia6 = listar_mensagem("6");$m6d=isset($dia6)?$dia6:6;
    $dia7 = listar_mensagem("7");$m7d=isset($dia7)?$dia7:7;
    $dia8 = listar_mensagem("8");$m8d=isset($dia8)?$dia8:8;
    $dia9 = listar_mensagem("9");$m9d=isset($dia9)?$dia9:9;
    $dia10 = listar_mensagem("10");$m10d=isset($dia10)?$dia10:"10-Sem aula";
    $dia11 = listar_mensagem("11");$m11d=isset($dia11)?$dia11:11;
    $dia12 = listar_mensagem("12");$m12d=isset($dia12)?$dia12:12;
    $dia13 = listar_mensagem("13");$m13d=isset($dia13)?$dia13:13;
    $dia14 = listar_mensagem("14");$m14d=isset($dia14)?$dia14:14;
    $dia15 = listar_mensagem("15");$m15d=isset($dia15)?$dia15:15;
    $dia16 = listar_mensagem("16");$m16d=isset($dia16)?$dia16:16;
    $dia17 = listar_mensagem("17");$m17d=isset($dia17)?$dia17:"17-Sem aula";
    $dia18 = listar_mensagem("18");$m18d=isset($dia18)?$dia18:18;
    $dia19 = listar_mensagem("19");$m19d=isset($dia19)?$dia19:19;
    $dia20 = listar_mensagem("20");$m20d=isset($dia20)?$dia20:20;
    $dia21 = listar_mensagem("21");$m21d=isset($dia21)?$dia21:21;
    $dia22 = listar_mensagem("22");$m22d=isset($dia22)?$dia22:22;
    $dia23 = listar_mensagem("23");$m23d=isset($dia23)?$dia23:23;
    $dia24 = listar_mensagem("24");$m24d=isset($dia24)?$dia24:"24-Sem aula";
    $dia25 = listar_mensagem("25");$m25d=isset($dia25)?$dia25:25;
    $dia26 = listar_mensagem("26");$m26d=isset($dia26)?$dia26:26;
    $dia27 = listar_mensagem("27");$m27d=isset($dia27)?$dia27:27;
    $dia28 = listar_mensagem("28");$m28d=isset($dia28)?$dia28:28;
    $dia29 = listar_mensagem("29");$m29d=isset($dia29)?$dia29:29;
    $dia30 = listar_mensagem("30");$m30d=isset($dia30)?$dia30:30;
    $dia31 = listar_mensagem("31");$m31d=isset($dia31)?$dia31:"31-Sem aula";
?>
<p id="workk">Tarefa</p>
<div id="aobis">
<table id="tabela">
    ...
    <tr><td id="1d" class="si"><?php echo"";?></td><td id="2d" class="se"><?php echo"";?></td><td id="3d" class="se"><?php echo"";?></td><td id="4d" class="se"><?php echo"";?></td><td id="5d" class="se"><?php echo"";?></td><td id="6d" class="se"><?php echo"$m1d";?></td><td id="7d" class="so"><?php echo"$m2d ";?></td></tr>
    <tr><td id="8d" class="si"><?php echo"$m3d";?></td><td id="9d" class="se"><?php echo"$m4d";?></td><td id="10d" class="se"><?php echo"$m5d";?></td><td id="11d" class="se"><?php echo"$m6d";?></td><td id="12d" class="se"><?php echo"$m7d ";?></td><td id="13d" class="se"><?php echo"$m8d";?></td><td id="14d" class="so"><?php echo"$m9d";?></td></tr>
    <tr><td id="15d" class="si"><?php echo"$m10d";?></td><td id="16d" class="se"><?php echo"$m11d";?></td><td id="17d" class="se"><?php echo"$m12d";?></td><td id="18d" class="se"><?php echo"$m13d";?></td><td id="19d" class="se"><?php echo"$m14d";?></td><td id="20d" class="se"><?php echo"$m15d";?></td><td id="21d" class="so"><?php echo"$m16d";?></td></tr>
    <tr><td id="22d" class="si"><?php echo"$m17d";?></td><td id="23d" class="se"><?php echo"$m18d";?></td><td id="24d" class="se"><?php echo"$m19d";?></td><td id="25d" class="se"><?php echo"$m20d";?></td><td id="26d" class="se"><?php echo"$m21d";?></td><td id="27d" class="se"><?php echo"$m22d";?></td><td id="28d" class="so"><?php echo"$m23d";?></td></tr>
    <tr><td id="29d" class="si"><?php echo"$m24d";?></td><td id="30d" class="se"><?php echo"$m25d";?></td><td id="36d" class="se"><?php echo"$m27d";?></td><td id="31d" class="se"><?php echo"$m26d";?></td><td id="32d" class="se"><?php echo"$m28d ";?></td><td id="33d" class="se"><?php echo"$m29d";?></td><td id="34d" class="so"><?php echo"$m30d";?></td></tr></tr>
    <tr><td id="35d" class="si"><?php echo"$m31d";?></tr>
</table>
</div>
<br>
<br>
