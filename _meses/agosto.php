...
if (isset($_POST["mtfa"])){
    ...
    $conferir14="SELECT * FROM t_agosto WHERE Day = $dia";
    //$conferir3="SELECT * FROM t_agosto WHERE  Day=$dia and Tarefa3 = NULL";
    $conferir1="SELECT * FROM t_agosto WHERE Day = $dia ";
   ...
   // $resp23=mysqli_query($con,$conferir23);
    ...
    $lin14=mysqli_num_rows($resp14);
        ...
        if ($lin14 == '0') { #Se não tiver nenhuma coluna, ou seja, o número for igual a 0, ela cria uma coluna nova.
            $sql="INSERT INTO t_agosto (Day, Tarefa) VALUES ($dia,'$maccabeus')";  #aqui ele seta para criar uma nova coluna, com o dia e a tarefa apresentada
            $res=mysqli_query($con,$sql);  #aqui ele cria definitivamente
        }
        if ($lin14 == '1' ) {
            $up2="UPDATE t_agosto SET Tarefa2='$maccabeus' WHERE Day=$dia";
...
if(isset($_POST["apg"])){
    $apaga=$_POST['apg'];
    $conferir2="SELECT * FROM t_agosto WHERE Day = $apaga";
    $resp2=mysqli_query($con,$conferir2);
    $lin2=mysqli_num_rows($resp2);
    echo $apaga;
        if ($lin2 > 0){
            $handel="DELETE FROM t_agosto WHERE Day = $apaga";
    ...
    //$consultat="SELECT * FROM t_agosto WHERE Day ='1'";
    //$cvc=$mysqli->query($consultat) or die($mysqli->error);
}
function listar_mensagem($lday){
    $con=mysqli_connect("localhost","root","vertrigo");
    mysqli_select_db($con,"calendario"); 
    $sql72 = "SELECT Tarefa, Tarefa2 FROM t_agosto WHERE Day = $lday";
...
<br><br>
<?php
    $dia1 = listar_mensagem("1");$zy1d=isset($dia1)?$dia1:1;
    $dia2 = listar_mensagem("2");$zy2d=isset($dia2)?$dia2:"2-Sem aula";
    $dia3 = listar_mensagem("3");$zy3d=isset($dia3)?$dia3:3;
    $dia4 = listar_mensagem("4");$zy4d=isset($dia4)?$dia4:4;
    $dia5 = listar_mensagem("5");$zy5d=isset($dia5)?$dia5:5;
    $dia6 = listar_mensagem("6");$zy6d=isset($dia6)?$dia6:6;
    $dia7 = listar_mensagem("7");$zy7d=isset($dia7)?$dia7:7;
    $dia8 = listar_mensagem("8");$zy8d=isset($dia8)?$dia8:8;
    $dia9 = listar_mensagem("9");$zy9d=isset($dia9)?$dia9:"9-Sem aula";
    $dia10 = listar_mensagem("10");$zy10d=isset($dia10)?$dia10:10;
    $dia11 = listar_mensagem("11");$zy11d=isset($dia11)?$dia11:11;
    $dia12 = listar_mensagem("12");$zy12d=isset($dia12)?$dia12:12;
    $dia13 = listar_mensagem("13");$zy13d=isset($dia13)?$dia13:13;
    $dia14 = listar_mensagem("14");$zy14d=isset($dia14)?$dia14:14;
    $dia15 = listar_mensagem("15");$zy15d=isset($dia15)?$dia15:15;
    $dia16 = listar_mensagem("16");$zy16d=isset($dia16)?$dia16:"16-Sem aula";
    $dia17 = listar_mensagem("17");$zy17d=isset($dia17)?$dia17:17;
    $dia18 = listar_mensagem("18");$zy18d=isset($dia18)?$dia18:18;
    $dia19 = listar_mensagem("19");$zy19d=isset($dia19)?$dia19:19;
    $dia20 = listar_mensagem("20");$zy20d=isset($dia20)?$dia20:20;
    $dia21 = listar_mensagem("21");$zy21d=isset($dia21)?$dia21:21;
    $dia22 = listar_mensagem("22");$zy22d=isset($dia22)?$dia22:22;
    $dia23 = listar_mensagem("23");$zy23d=isset($dia23)?$dia23:"23-Sem aula";
    $dia24 = listar_mensagem("24");$zy24d=isset($dia24)?$dia24:24;
    $dia25 = listar_mensagem("25");$zy25d=isset($dia25)?$dia25:25;
    $dia26 = listar_mensagem("26");$zy26d=isset($dia26)?$dia26:26;
    $dia27 = listar_mensagem("27");$zy27d=isset($dia27)?$dia27:27;
    $dia28 = listar_mensagem("28");$zy28d=isset($dia28)?$dia28:28;
    $dia29 = listar_mensagem("29");$zy29d=isset($dia29)?$dia29:29;
    $dia30 = listar_mensagem("30");$zy30d=isset($dia30)?$dia30:"30-Sem aula";
    $dia31 = listar_mensagem("31");$zy31d=isset($dia31)?$dia31:31;
?>
<p id="workk">Tarefa</p>
<div id="aobis">
<table id="tabela">
    ...
    <tr><td class="si"><?php echo"";?></td><td class="se"><?php echo"";?></td><td class="se"><?php echo"";?></td><td class="se"><?php echo"";?></td><td class="se"><?php echo"";?></td><td class="se"><?php echo"";?></td><td id="1d" class="so"><?php echo"$zy1d";?></td></tr>
    <tr><td id="2d" class="si"><?php echo"$zy2d ";?></td><td id="3d" class="se"><?php echo"$zy3d ";?></td><td id="4d" class="se"><?php echo"$zy4d ";?></td><td id="5d" class="se"><?php echo"$zy5d ";?></td><td id="6d" class="se"><?php echo"$zy6d";?></td><td id="7d" class="se"><?php echo"$zy7d";?></td><td id="8d" class="so"><?php echo"$zy8d ";?></td></tr>
    <tr><td id="9d" class="si"><?php echo"$zy9d ";?></td><td id="10d" class="se"><?php echo"$zy10d ";?></td><td id="11d" class="se"><?php echo"$zy11d ";?></td><td id="12d" class="se"><?php echo"$zy12d ";?></td><td id="13d" class="se"><?php echo"$zy13d";?></td><td id="14d" class="se"><?php echo"$zy14d ";?></td><td id="15d" class="so"><?php echo"$zy15d ";?></td></tr>
    <tr><td id="16d" class="si"><?php echo"$zy16d ";?></td><td id="17d" class="se"><?php echo"$zy17d";?></td><td id="18d" class="se"><?php echo"$zy18d ";?></td><td id="19d" class="se"><?php echo"$zy19d ";?></td><td id="20d" class="se"><?php echo"$zy20d";?></td><td id="21d" class="se"><?php echo"$zy21d ";?></td><td id="22d" class="so"><?php echo"$zy22d ";?></td></tr>
    <tr><td id="23d" class="si"><?php echo"$zy23d ";?></td><td id="24d" class="se"><?php echo"$zy24d ";?></td><td id="25d" class="se"><?php echo"$zy25d ";?></td><td id="26d" class="se"><?php echo"$zy26d";?></td><td id="27d" class="se"><?php echo"$zy27d ";?></td><td id="28d" class="se"><?php echo"$zy28d";?></td><td id="29d" class="so"><?php echo"$zy29d ";?></td></tr>
    <tr><td id="30d" class="si"><?php echo"$zy30d ";?></td><td id="31d" class="se"><?php echo"$zy31d ";?></td></tr>
</table>
</div>
<br>
<br>
