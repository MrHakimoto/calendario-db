...
if (isset($_POST["mtfa"])){
    ...
    $conferir14="SELECT * FROM t_janeiro WHERE Day = $dia";
    //$conferir3="SELECT * FROM t_janeiro WHERE  Day=$dia and Tarefa3 = NULL";
    $conferir1="SELECT * FROM t_janeiro WHERE Day = $dia ";
   ...
   // $resp23=mysqli_query($con,$conferir23);
    ...
    $lin14=mysqli_num_rows($resp14);
        ...
        if ($lin14 == '0') { #Se não tiver nenhuma coluna, ou seja, o número for igual a 0, ela cria uma coluna nova.
            $sql="INSERT INTO t_janeiro (Day, Tarefa) VALUES ($dia,'$maccabeus')";  #aqui ele seta para criar uma nova coluna, com o dia e a tarefa apresentada
            $res=mysqli_query($con,$sql);  #aqui ele cria definitivamente
        }
        if ($lin14 == '1' ) {
            $up2="UPDATE t_janeiro SET Tarefa2='$maccabeus' WHERE Day=$dia";
...
if(isset($_POST["apg"])){
    $apaga=$_POST['apg'];
    $conferir2="SELECT * FROM t_janeiro WHERE Day = $apaga";
    $resp2=mysqli_query($con,$conferir2);
    $lin2=mysqli_num_rows($resp2);
    echo $apaga;
        if ($lin2 > 0){
            $handel="DELETE FROM t_janeiro WHERE Day = $apaga";
    ...
    //$consultat="SELECT * FROM t_janeiro WHERE Day ='1'";
    //$cvc=$mysqli->query($consultat) or die($mysqli->error);
}
function listar_mensagem($lday){
    $con=mysqli_connect("localhost","root","vertrigo");
    mysqli_select_db($con,"calendario"); 
    $sql72 = "SELECT Tarefa, Tarefa2 FROM t_janeiro WHERE Day = $lday";
...
<p>oba</p><br>
<?php
    $dia1 = listar_mensagem("1");$jao1d=isset($dia1)?$dia1:1;
    $dia2 = listar_mensagem("2");$jao2d=isset($dia2)?$dia2:2;
    $dia3 = listar_mensagem("3");$jao3d=isset($dia3)?$dia3:3;
    $dia4 = listar_mensagem("4");$jao4d=isset($dia4)?$dia4:4;
    $dia5 = listar_mensagem("5");$jao5d=isset($dia5)?$dia5:"5-Sem aula";//
    $dia6 = listar_mensagem("6");$jao6d=isset($dia6)?$dia6:6;
    $dia7 = listar_mensagem("7");$jao7d=isset($dia7)?$dia7:7;
    $dia8 = listar_mensagem("8");$jao8d=isset($dia8)?$dia8:8;
    $dia9 = listar_mensagem("9");$jao9d=isset($dia9)?$dia9:9;
    $dia10 = listar_mensagem("10");$jao10d=isset($dia10)?$dia10:10;
    $dia11 = listar_mensagem("11");$jao11d=isset($dia11)?$dia11:11;
    $dia12 = listar_mensagem("12");$jao12d=isset($dia12)?$dia12:"12-Sem aula";//
    $dia13 = listar_mensagem("13");$jao13d=isset($dia13)?$dia13:13;
    $dia14 = listar_mensagem("14");$jao14d=isset($dia14)?$dia14:14;
    $dia15 = listar_mensagem("15");$jao15d=isset($dia15)?$dia15:15;
    $dia16 = listar_mensagem("16");$jao16d=isset($dia16)?$dia16:16;
    $dia17 = listar_mensagem("17");$jao17d=isset($dia17)?$dia17:17;
    $dia18 = listar_mensagem("18");$jao18d=isset($dia18)?$dia18:18;
    $dia19 = listar_mensagem("19");$jao19d=isset($dia19)?$dia19:"19-Sem aula";//
    $dia20 = listar_mensagem("20");$jao20d=isset($dia20)?$dia20:20;
    $dia21 = listar_mensagem("21");$jao21d=isset($dia21)?$dia21:21;
    $dia22 = listar_mensagem("22");$jao22d=isset($dia22)?$dia22:22;
    $dia23 = listar_mensagem("23");$jao23d=isset($dia23)?$dia23:23;
    $dia24 = listar_mensagem("24");$jao24d=isset($dia24)?$dia24:24;
    $dia25 = listar_mensagem("25");$jao25d=isset($dia25)?$dia25:25;
    $dia26 = listar_mensagem("26");$jao26d=isset($dia26)?$dia26:"26-Sem aula";//
    $dia27 = listar_mensagem("27");$jao27d=isset($dia27)?$dia27:27;
    $dia28 = listar_mensagem("28");$jao28d=isset($dia28)?$dia28:28;
    $dia29 = listar_mensagem("29");$jao29d=isset($dia29)?$dia29:29;
    $dia30 = listar_mensagem("30");$jao30d=isset($dia30)?$dia30:30;
    $dia31 = listar_mensagem("31");$jao31d=isset($dia31)?$dia31:31;
?>
<p>oba</p><br>
<div  id="corpo">
...
<table id="tabela">
    ...
    <tr><td id="33d" class="si"><?php echo"";?></td><td id="32d" class="se"><?php echo"";?></td><td id="33d" class="se"><?php echo"";?></td><td id="1d" class="se"><?php echo"$jao1d";?></td><td id="2d" class="se"><?php echo"$jao2d ";?></td><td id="3d" class="se"><?php echo"$jao3d";?></td><td id="4d" class="so"><?php echo"$jao4d";?></td></tr>
    <tr><td id="5d" class="si"><?php echo"$jao5d";?></td><td id="6d" class="se"><?php echo"$jao6d ";?></td><td id="7d" class="se"><?php echo"$jao7d";?></td><td id="8d" class="se"><?php echo"$jao8d ";?></td><td id="9d" class="se"><?php echo"$jao9d ";?></td><td id="10d" class="se"><?php echo"$jao10d";?></td><td id="11d" class="so"><?php echo"$jao11d ";?></td></tr>
    <tr><td id="12d" class="si"><?php echo"$jao12d ";?></td><td id="13d" class="se"><?php echo"$jao13d ";?></td><td id="14d" class="se"><?php echo"$jao14d";?></td><td id="15d" class="se"><?php echo"$jao15d ";?></td><td id="16d" class="se"><?php echo"$jao16d";?></td><td id="17d" class="se"><?php echo"$jao17d ";?></td><td id="18d" class="so"><?php echo"$jao18d ";?></td></tr>
    <tr><td id="19d" class="si"><?php echo"$jao19d ";?></td><td id="20d" class="se"><?php echo"$jao20d ";?></td><td id="21d" class="se"><?php echo"$jao21d ";?></td><td id="22d" class="se"><?php echo"$jao22d ";?></td><td id="23d" class="se"><?php echo"$jao23d ";?></td><td id="24d" class="se"><?php echo"$jao24d";?></td><td id="25d" class="so"><?php echo"$jao25d ";?></td></tr>
    <tr><td id="26d" class="si"><?php echo"$jao26d ";?></td><td id="27d" class="se"><?php echo"$jao27d ";?></td><td id="28d" class="se"><?php echo"$jao28d ";?></td><td id="29d" class="se"><?php echo"$jao29d ";?></td><td id="30d" class="se"><?php echo"$jao30d";?></td></tr>
</table>
</div>
<br>
<br>
