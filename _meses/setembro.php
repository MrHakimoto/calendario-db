...
if (isset($_POST["mtfa"])){
    ...
    $conferir14="SELECT * FROM t_setembro WHERE Day = $dia";
    //$conferir3="SELECT * FROM t_setembro WHERE  Day=$dia and Tarefa3 = NULL";
    $conferir1="SELECT * FROM t_setembro WHERE Day = $dia ";
   ...
   // $resp23=mysqli_query($con,$conferir23);
    ...
    $lin14=mysqli_num_rows($resp14);
        ...
        if ($lin14 == '0') { #Se não tiver nenhuma coluna, ou seja, o número for igual a 0, ela cria uma coluna nova.
            $sql="INSERT INTO t_setembro (Day, Tarefa) VALUES ($dia,'$maccabeus')";  #aqui ele seta para criar uma nova coluna, com o dia e a tarefa apresentada
            $res=mysqli_query($con,$sql);  #aqui ele cria definitivamente
        }
        if ($lin14 == '1' ) {
            $up2="UPDATE t_setembro SET Tarefa2='$maccabeus' WHERE Day=$dia";
...
if(isset($_POST["apg"])){
    $apaga=$_POST['apg'];
    $conferir2="SELECT * FROM t_setembro WHERE Day = $apaga";
    $resp2=mysqli_query($con,$conferir2);
    $lin2=mysqli_num_rows($resp2);
    echo $apaga;
        if ($lin2 > 0){
            $handel="DELETE FROM t_setembro WHERE Day = $apaga";
    ...
    //$consultat="SELECT * FROM t_setembro WHERE Day ='1'";
    //$cvc=$mysqli->query($consultat) or die($mysqli->error);
}
function listar_mensagem($lday){
    $con=mysqli_connect("localhost","root","vertrigo");
    mysqli_select_db($con,"calendario"); 
    $sql72 = "SELECT Tarefa, Tarefa2 FROM t_setembro WHERE Day = $lday";
...
<br><br>
<?php
    $dia1 = listar_mensagem("1");$rz1d=isset($dia1)?$dia1:1;
    $dia2 = listar_mensagem("2");$rz2d=isset($dia2)?$dia2:2;
    $dia3 = listar_mensagem("3");$rz3d=isset($dia3)?$dia3:3;
    $dia4 = listar_mensagem("4");$rz4d=isset($dia4)?$dia4:4;
    $dia5 = listar_mensagem("5");$rz5d=isset($dia5)?$dia5:5;
    $dia6 = listar_mensagem("6");$rz6d=isset($dia6)?$dia6:"6-Sem aula";
    $dia7 = listar_mensagem("7");$rz7d=isset($dia7)?$dia7:7;
    $dia8 = listar_mensagem("8");$rz8d=isset($dia8)?$dia8:8;
    $dia9 = listar_mensagem("9");$rz9d=isset($dia9)?$dia9:9;
    $dia10 = listar_mensagem("10");$rz10d=isset($dia10)?$dia10:10;
    $dia11 = listar_mensagem("11");$rz11d=isset($dia11)?$dia11:11;
    $dia12 = listar_mensagem("12");$rz12d=isset($dia12)?$dia12:12;
    $dia13 = listar_mensagem("13");$rz13d=isset($dia13)?$dia13:"13-Sem aula";
    $dia14 = listar_mensagem("14");$rz14d=isset($dia14)?$dia14:14;
    $dia15 = listar_mensagem("15");$rz15d=isset($dia15)?$dia15:15;
    $dia16 = listar_mensagem("16");$rz16d=isset($dia16)?$dia16:16;
    $dia17 = listar_mensagem("17");$rz17d=isset($dia17)?$dia17:17;
    $dia18 = listar_mensagem("18");$rz18d=isset($dia18)?$dia18:18;
    $dia19 = listar_mensagem("19");$rz19d=isset($dia19)?$dia19:19;
    $dia20 = listar_mensagem("20");$rz20d=isset($dia20)?$dia20:"20-Sem aula";
    $dia21 = listar_mensagem("21");$rz21d=isset($dia21)?$dia21:21;
    $dia22 = listar_mensagem("22");$rz22d=isset($dia22)?$dia22:22;
    $dia23 = listar_mensagem("23");$rz23d=isset($dia23)?$dia23:23;
    $dia24 = listar_mensagem("24");$rz24d=isset($dia24)?$dia24:24;
    $dia25 = listar_mensagem("25");$rz25d=isset($dia25)?$dia25:25;
    $dia26 = listar_mensagem("26");$rz26d=isset($dia26)?$dia26:26;
    $dia27 = listar_mensagem("27");$rz27d=isset($dia27)?$dia27:"27-Sem aula";
    $dia28 = listar_mensagem("28");$rz28d=isset($dia28)?$dia28:28;
    $dia29 = listar_mensagem("29");$rz29d=isset($dia29)?$dia29:29;
    $dia30 = listar_mensagem("30");$rz30d=isset($dia30)?$dia30:30;
    $dia31 = listar_mensagem("31");$rz31d=isset($dia31)?$dia31:31;
?>
<p id="workk">Tarefa</p>
<div id="aobis">
<table id="tabela">
    ...
    <tr><td id="1d" class="si"><?php echo"";?></td><td id="2d" class="se"><?php echo"";?></td><td id="1d" class="se"><?php echo"$rz1d ";?></td><td id="2d" class="se"><?php echo"$rz2d ";?></td><td id="3d" class="se"><?php echo"$rz3d";?></td><td id="4d" class="se"><?php echo"$rz4d ";?></td><td id="5d" class="so"><?php echo"$rz5d";?></td></tr>
    <tr><td id="6d" class="si"><?php echo"$rz6d ";?></td><td id="7d" class="se"><?php echo"$rz7d ";?></td><td id="8d" class="se"><?php echo"$rz8d ";?></td><td id="9d" class="se"><?php echo"$rz9d ";?></td><td id="10d" class="se"><?php echo"$rz10d ";?></td><td id="11d" class="se"><?php echo"$rz11d ";?></td><td id="12d" class="so"><?php echo"$rz12d";?></td></tr>
    <tr><td id="13d" class="si"><?php echo"$rz13d ";?></td><td id="14d" class="se"><?php echo"$rz14d ";?></td><td id="15d" class="se"><?php echo"$rz15d ";?></td><td id="16d" class="se"><?php echo"$rz16d";?></td><td id="17d" class="se"><?php echo"$rz17d ";?></td><td id="18d" class="se"><?php echo"$rz18d ";?></td><td id="19d" class="so"><?php echo"$rz19d";?></td></tr>
    <tr><td id="20d" class="si"><?php echo"$rz20d ";?></td><td id="21d" class="se"><?php echo"$rz21d ";?></td><td id="22d" class="se"><?php echo"$rz22d ";?></td><td id="23d" class="se"><?php echo"$rz23d ";?></td><td id="24d" class="se"><?php echo"$rz24d ";?></td><td id="25d" class="se"><?php echo"$rz25d";?></td><td id="26d" class="so"><?php echo"$rz26d ";?></td></tr>
    <tr><td id="27d" class="si"><?php echo"$rz27d ";?></td><td id="28d" class="se"><?php echo"$rz28d ";?></td><td id="29d" class="se"><?php echo"$rz29d ";?></td><td id="30d" class="se"><?php echo"$rz30d ";?></td></tr>
</table>
</div>
<br>
<br>
