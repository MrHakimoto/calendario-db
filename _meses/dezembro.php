...
if (isset($_POST["mtfa"])){
    ...
    $conferir14="SELECT * FROM t_dezembro WHERE Day = $dia";
    //$conferir3="SELECT * FROM t_dezembro WHERE  Day=$dia and Tarefa3 = NULL";
    $conferir1="SELECT * FROM t_dezembro WHERE Day = $dia ";
   ...
   // $resp23=mysqli_query($con,$conferir23);
    ...
    $lin14=mysqli_num_rows($resp14);
        ...
        if ($lin14 == '0') { #Se não tiver nenhuma coluna, ou seja, o número for igual a 0, ela cria uma coluna nova.
            $sql="INSERT INTO t_dezembro (Day, Tarefa) VALUES ($dia,'$maccabeus')";  #aqui ele seta para criar uma nova coluna, com o dia e a tarefa apresentada
            $res=mysqli_query($con,$sql);  #aqui ele cria definitivamente
        }
        if ($lin14 == '1' ) {
            $up2="UPDATE t_dezembro SET Tarefa2='$maccabeus' WHERE Day=$dia";
...
if(isset($_POST["apg"])){
    $apaga=$_POST['apg'];
    $conferir2="SELECT * FROM t_dezembro WHERE Day = $apaga";
    $resp2=mysqli_query($con,$conferir2);
    $lin2=mysqli_num_rows($resp2);
    echo $apaga;
        if ($lin2 > 0){
            $handel="DELETE FROM t_dezembro WHERE Day = $apaga";
    ...
    //$consultat="SELECT * FROM t_dezembro WHERE Day ='1'";
    //$cvc=$mysqli->query($consultat) or die($mysqli->error);
}
function listar_mensagem($lday){
    $con=mysqli_connect("localhost","root","vertrigo");
    mysqli_select_db($con,"calendario"); 
    $sql72 = "SELECT Tarefa, Tarefa2 FROM t_dezembro WHERE Day = $lday";
...
<br><br>
<?php
    $dia1 = listar_mensagem("1");$zd1d=isset($dia1)?$dia1:1;
    $dia2 = listar_mensagem("2");$zd2d=isset($dia2)?$dia2:2;
    $dia3 = listar_mensagem("3");$zd3d=isset($dia3)?$dia3:3;
    $dia4 = listar_mensagem("4");$zd4d=isset($dia4)?$dia4:4;
    $dia5 = listar_mensagem("5");$zd5d=isset($dia5)?$dia5:5;
    $dia6 = listar_mensagem("6");$zd6d=isset($dia6)?$dia6:"6-Sem aula";
    $dia7 = listar_mensagem("7");$zd7d=isset($dia7)?$dia7:7;
    $dia8 = listar_mensagem("8");$zd8d=isset($dia8)?$dia8:8;
    $dia9 = listar_mensagem("9");$zd9d=isset($dia9)?$dia9:9;
    $dia10 = listar_mensagem("10");$zd10d=isset($dia10)?$dia10:10;
    $dia11 = listar_mensagem("11");$zd11d=isset($dia11)?$dia11:11;
    $dia12 = listar_mensagem("12");$zd12d=isset($dia12)?$dia12:12;
    $dia13 = listar_mensagem("13");$zd13d=isset($dia13)?$dia13:"13-Sem aula";
    $dia14 = listar_mensagem("14");$zd14d=isset($dia14)?$dia14:14;
    $dia15 = listar_mensagem("15");$zd15d=isset($dia15)?$dia15:15;
    $dia16 = listar_mensagem("16");$zd16d=isset($dia16)?$dia16:16;
    $dia17 = listar_mensagem("17");$zd17d=isset($dia17)?$dia17:17;
    $dia18 = listar_mensagem("18");$zd18d=isset($dia18)?$dia18:18;
    $dia19 = listar_mensagem("19");$zd19d=isset($dia19)?$dia19:19;
    $dia20 = listar_mensagem("20");$zd20d=isset($dia20)?$dia20:"20-Sem aula";
    $dia21 = listar_mensagem("21");$zd21d=isset($dia21)?$dia21:21;
    $dia22 = listar_mensagem("22");$zd22d=isset($dia22)?$dia22:22;
    $dia23 = listar_mensagem("23");$zd23d=isset($dia23)?$dia23:23;
    $dia24 = listar_mensagem("24");$zd24d=isset($dia24)?$dia24:24;
    $dia25 = listar_mensagem("25");$zd25d=isset($dia25)?$dia25:25;
    $dia26 = listar_mensagem("26");$zd26d=isset($dia26)?$dia26:26;
    $dia27 = listar_mensagem("27");$zd27d=isset($dia27)?$dia27:"27-Sem aula";
    $dia28 = listar_mensagem("28");$zd28d=isset($dia28)?$dia28:28;
    $dia29 = listar_mensagem("29");$zd29d=isset($dia29)?$dia29:29;
    $dia30 = listar_mensagem("30");$zd30d=isset($dia30)?$dia30:30;
    $dia31 = listar_mensagem("31");$zd31d=isset($dia31)?$dia31:31;
?>
<p id="workk">Tarefa</p>
<div id="aobis">
<table id="tabela">
    ...
    <tr><td id="1d" class="si"><?php echo"";?></td><td id="2d" class="se"><?php echo"";?></td><td id="1d" class="se"><?php echo"$zd1d ";?></td><td id="2d" class="se"><?php echo"$zd2d ";?></td><td id="3d" class="se"><?php echo"$zd3d ";?></td><td id="4d" class="se"><?php echo"$zd4d ";?></td><td id="5d" class="so"><?php echo"$zd5d ";?></td></tr>
    <tr><td id="6d" class="si"><?php echo"$zd6d ";?></td><td id="7d" class="se"><?php echo"$zd7d ";?></td><td id="8d" class="se"><?php echo"$zd8d";?></td><td id="9d" class="se"><?php echo"$zd9d ";?></td><td id="10d" class="se"><?php echo"$zd10d ";?></td><td id="11d" class="se"><?php echo"$zd11d ";?></td><td id="12d" class="so"><?php echo"$zd12d";?></td></tr>
    <tr><td id="13d" class="si"><?php echo"$zd13d ";?></td><td id="14d" class="se"><?php echo"$zd14d ";?></td><td id="15d" class="se"><?php echo"$zd15d ";?></td><td id="16d" class="se"><?php echo"$zd16d ";?></td><td id="17d" class="se"><?php echo"$zd17d ";?></td><td id="18d" class="se"><?php echo"$zd18d ";?></td><td id="19d" class="so"><?php echo"$zd19d ";?></td></tr>
    <tr><td id="20d" class="si"><?php echo"$zd20d ";?></td><td id="21d" class="se"><?php echo"$zd21d ";?></td><td id="22d" class="se"><?php echo"$zd22d ";?></td><td id="23d" class="se"><?php echo"$zd23d ";?></td><td id="24d" class="se"><?php echo"$zd24d ";?></td><td id="25d" class="se"><?php echo"$zd25d ";?></td><td id="26d" class="so"><?php echo"$zd26d ";?></td></tr>
    <tr><td id="27d" class="si"><?php echo"$zd27d ";?></td><td id="28d" class="se"><?php echo"$zd28d ";?></td><td id="29d" class="se"><?php echo"$zd29d ";?></td><td id="30d" class="se"><?php echo"$zd30d ";?></td><td id="31d" class="se"><?php echo"$zd31d ";?></td></tr>
</table>
</div>
<br>
<br>
